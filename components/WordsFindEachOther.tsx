...
export default function WordsFindEachOther({ closeness }: { closeness: MotionValue<number> }) {
  ...
  return (
    ...
    <h1 className="font-tagline italic font-normal text-5xl sm:text-6xl md:text-7xl tracking-tight text-ink text-center leading-[1.1] flex flex-col items-center">

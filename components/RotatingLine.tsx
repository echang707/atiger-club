...
export default function RotatingLine({
  ...
  return (
    <div className="h-16 md:h-12 flex items-center justify-center overflow-hidden">
      <AnimatePresence mode="wait">
        {visible && (
          <motion.p
            ...
            className="flex items-center gap-2 text-ink/65 font-medium text-base md:text-lg text-center px-6"
          >
